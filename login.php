...
<?php include 'template/header/top-header.php';?>
    ...
    <main class="auth">
      <header id="auth-header" class="auth-header" style="background-color:#f7f7f7;">
        <h1>
          <!-- <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" height="64" viewbox="0 0 351 100"> -->
          <div class="text-center text-primary">
            <img src="assets/images/udsm-logo.png" alt="" class="img-fluid" style="height:70px; width:130px;">
          <h1>ULMS</h1>
      ...
      <form class="auth-form" action="validation/login_process.php" method="post">
        <!-- .form-group -->
        <div class="row">
        ...
        <div class="form-group">
          ...
          <div class="form-label-group">
            ...
            <input type="email" id="inputUser" name="email" class="form-control" placeholder="Username" autofocus=""> <label for="inputUser">Enter Staff Email</label>
          </div>
        </div><!-- /.form-group -->
        <!-- .form-group -->
        <div class="form-group">
          ...
          <div class="form-label-group">
            <input type="password" id="inputPassword" name="password" class="form-control" placeholder="Password"> <label for="inputPassword">Enter Password</label>
          </div>
        </div><!-- /.form-group -->
        <!-- .form-group -->
        <div class="form-group">
          ...
          <?php
          if(isset($_SESSION['incorrect_details_1'])){
            echo $_SESSION['incorrect_details_1'];
          unset($_SESSION['incorrect_details_1']);
          }
          ?>
          <?php
          if(isset($_SESSION['incorrect_details_2'])){
            echo $_SESSION['incorrect_details_2'];
          unset($_SESSION['incorrect_details_2']);
          }
          ?>
        </div><!-- /.form-group -->
        <!-- .form-group -->
        <div class="form-group text-center">
          <div class="custom-control custom-control-inline custom-checkbox">
            <input type="checkbox" class="custom-control-input" id="remember-me"> <label class="custom-control-label" for="remember-me">Keep me </label>
          </div>
        </div><!-- /.form-group -->
        <!-- recovery links -->
      </form><!-- /.auth-form -->
      <!-- copyright -->
      <footer class="auth-footer"> © <?php echo date('Y');?> All Rights Reserved. <a href="htttps://coict.udsm.ac.tz">UDSM-COICT</a>
      </footer>
    </main><!-- /.auth -->
    <!-- BEGIN BASE JS -->
