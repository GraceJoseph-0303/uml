    ...
    <div class="top-bar-list">
      ...
      <div class="top-bar-item top-bar-item-right px-0 d-none d-sm-flex">
        ...
        <div class="dropdown d-none d-md-flex">
          <button class="btn-account" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <span class="account-summary pr-lg-4 d-none d-lg-block"><span class="account-name">UDSM STAFF</span> <span class="account-description"><?php echo $full_name;?></span></span></button> <!-- .dropdown-menu -->
          <div class="dropdown-menu">
            <div class="dropdown-arrow d-lg-none" x-arrow=""></div>
            <div class="dropdown-arrow ml-3 d-none d-lg-block"></div>
            <h6 class="dropdown-header d-none d-md-block d-lg-none"> UDSM STAFF </h6><a class="dropdown-item" href="user-profile.html">
            <a class="dropdown-item" href="profile.php"><span class="dropdown-icon oi oi-person"></span> Profile</a>
            <a class="dropdown-item" href="change_password.php"><span class="dropdown-icon oi oi-book"></span>Change Password</a>
            <a class="dropdown-item" href="logout.php"><span class="dropdown-icon oi oi-lock"></span>Log Out</a>
